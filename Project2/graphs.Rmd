...
### variables that should be factor columns
+ Bowl.Setpoint
+ Pressure.Setpoint
+ PSC.CO2
+ I added some visualization and rounded for these variables. I don't think these changes will amke any difference in modeling results(all seem distributed evenly around the mean of PH), but I think we should still include it in EDA as it shows how "deeply" we looked into the data.  
...
## Setpoint seems to sequence by 10 integers, and then has random integers towards the end.  filtered
## for those rnadom observations to see any trend. I then visualize the variable.  I don't believe we need
...
ritesh.lohiya06@spsmail.cuny.edu
jun.yan35@spsmail.cuny.edu
```
